...
bool MainWindow::graficarWavelet(QVector<QVector<double>> s, QCustomPlot *grafico, int a, int b){
    ...
    qDebug()<<"[F: graficarWavelet()] Graficando ColorMap (graficarWavelet) : columnas="<<col<<" ; filas="<<filas<<endl;
...
void MainWindow::chargeData(){
    ...
    case 2:
        ...
        break;
    case 3:
        FN->graficarWavelet(graffico, sigActual->resultSignal, amin, bmax, sigActual->getFs().toDouble());
        //graficarWavelet(sigActual->resultSignal, graffico, amin, bmax);
        break;
    case 4:
        FN->graficarSpectrogram(graffico, sigActual->resultSignal, amin, bmax, sigActual->getFs().toDouble());
...
void MainWindow::on_actionDemo_Se_al_Greasy_csv_triggered()
{
    if(ExistenModificaciones("Demo 4")){
        ...
        cSignal *signal = new cSignal();
        QString path = ":/ejemplos/greasy.csv";
        QString archivo_recuperado = "";
        QFile file(path);
