...
void funcionesGraficas::cargaGrafica(QCheckBox *checkBox,QCustomPlot *grafico, QComboBox *cBox, int canal, DelSignal *signal)
{    
    cBox->clear();
    if( leer(signal)==true){
...
bool funcionesGraficas::leer(DelSignal *signal)
{
...
bool funcionesGraficas::graficarSpectrogram(QVector<QVector<double>> s, int a, int b, double Fs)
{
    QCustomPlot *grafico = new QCustomPlot();
...
void funcionesGraficas::graficarFourier(QVector<QVector<double>> s, int a, int b, QStringList parametros){
    (void) a;
    (void) b;
    QCustomPlot *grafico = new QCustomPlot();
...
bool funcionesGraficas::graficarGabor(QVector<QVector<double> > s, int a, int b, double Fs)
{
    QCustomPlot *grafico = new QCustomPlot();
    restaurarGrafico(grafico);
    double fs = Fs*1000;
...
void funcionesGraficas::graficarHistograma(QVector<QVector<double>> s, QString tipo)
{
    QCustomPlot *grafico = new QCustomPlot();
    ...
    centrarGraficos("Histograma",grafico,500,400);
...
void funcionesGraficas::graficarMovingRms(QVector<double> s, QVector<double> t, int a, int b){
...
void funcionesGraficas::graficarMeanFrequency(QVector<double> result, double fs, int a, int b, QString tipo)
{
    QCustomPlot *graffico = new QCustomPlot();
    restaurarGrafico(graffico);
