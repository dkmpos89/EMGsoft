...
"}"));
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/imagenes/qt.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAbout_Qt_creator->setIcon(icon5);
        actionReportar_Bug = new QAction(MainWindow);
        actionReportar_Bug->setObjectName(QStringLiteral("actionReportar_Bug"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/imagenes/bug.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReportar_Bug->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/imagenes/closeAll.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        action_doTest->setIcon(icon8);
        actionBase_de_Datos = new QAction(MainWindow);
        actionBase_de_Datos->setObjectName(QStringLiteral("actionBase_de_Datos"));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/imagenes/logoSqlite.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBase_de_Datos->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/imagenes/Gear.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionParametros_Generales->setIcon(icon10);
        actionCerrar_se_al = new QAction(MainWindow);
        actionCerrar_se_al->setObjectName(QStringLiteral("actionCerrar_se_al"));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/imagenes/Task Manager.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionCerrar_se_al->setIcon(icon11);
        actionDemo_Se_al_1_csv = new QAction(MainWindow);
        actionDemo_Se_al_1_csv->setObjectName(QStringLiteral("actionDemo_Se_al_1_csv"));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/imagenes/1.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDemo_Se_al_1_csv->setIcon(icon12);
        actionDemo_Se_al_2_txt = new QAction(MainWindow);
        actionDemo_Se_al_2_txt->setObjectName(QStringLiteral("actionDemo_Se_al_2_txt"));
        QIcon icon13;
        icon13.addFile(QStringLiteral(":/imagenes/2.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDemo_Se_al_2_txt->setIcon(icon13);
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/imagenes/AnalisisMultiple.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAnalisis_Multiple->setIcon(icon14);
        actionUndo = new QAction(MainWindow);
        actionUndo->setObjectName(QStringLiteral("actionUndo"));
        QIcon icon15;
        icon15.addFile(QStringLiteral(":/imagenes/045.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/imagenes/026.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRedoOriginal->setIcon(icon16);
        actionDemo_Se_al_3_csv = new QAction(MainWindow);
        actionDemo_Se_al_3_csv->setObjectName(QStringLiteral("actionDemo_Se_al_3_csv"));
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/imagenes/3.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDemo_Se_al_3_csv->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QStringLiteral(":/imagenes/graph_statistics.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_informacion_actual_sig->setIcon(icon18);
        ...
        infoProyecto_GB = new QGroupBox(tabVP);
        infoProyecto_GB->setObjectName(QStringLiteral("infoProyecto_GB"));
        infoProyecto_GB->setMinimumSize(QSize(0, 300));
        infoProyecto_GB->setMaximumSize(QSize(250, 16777215));
        infoProyecto_GB->setFont(font);
        infoProyecto_GB->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        gridLayout_6 = new QGridLayout(infoProyecto_GB);
        gridLayout_6->setSpacing(6);
        gridLayout_6->setContentsMargins(11, 11, 11, 11);
        gridLayout_6->setObjectName(QStringLiteral("gridLayout_6"));
        groupBox_3 = new QGroupBox(infoProyecto_GB);
        ...
        nombreProyectoActual = new QLabel(infoProyecto_GB);
...
" }"));
        ...
        label_2 = new QLabel(infoProyecto_GB);
        ...
        label_3 = new QLabel(infoProyecto_GB);
        ...
        label_19 = new QLabel(infoProyecto_GB);
        ...
        informacionSesion = new QLabel(infoProyecto_GB);
...
" }"));
        ...
        informacionRUT = new QLabel(infoProyecto_GB);
...
" }"));
        ...
        label_18 = new QLabel(infoProyecto_GB);
        ...
        label_20 = new QLabel(infoProyecto_GB);
        ...
        label_21 = new QLabel(infoProyecto_GB);
        ...
        horizontalLayout->addWidget(infoProyecto_GB);
...
" }"));
        ...
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/imagenes/open.ico"), QSize(), QIcon::Normal, QIcon::Off);
        btnOpenG1->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QStringLiteral(":/imagenes/save_as.ico"), QSize(), QIcon::Normal, QIcon::Off);
        btnSaveImageG1->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QStringLiteral(":/imagenes/guardar-archivo.ico"), QSize(), QIcon::Normal, QIcon::Off);
        btnExportarG1->setIcon(icon21);
        ...
        sizePolicy2.setHeightForWidth(swSesion->sizePolicy().hasHeightForWidth());
        swSesion->setSizePolicy(sizePolicy2);
...
" }"));
        ...
        sizePolicy3.setHeightForWidth(toolBoxGrafico2->sizePolicy().hasHeightForWidth());
        toolBoxGrafico2->setSizePolicy(sizePolicy3);
        ...
        QIcon icon22;
        icon22.addFile(QStringLiteral(":/imagenes/020.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnSaveImageG2->setIcon(icon22);
        ...
        QIcon icon23;
        icon23.addFile(QStringLiteral(":/imagenes/csv_txt.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnSaveDataG2->setIcon(icon23);
        ...
        QIcon icon24;
        icon24.addFile(QStringLiteral(":/imagenes/arrowApply.png"), QSize(), QIcon::Normal, QIcon::Off);
        comboFiltros_2->addItem(icon24, QString());
        comboFiltros_2->addItem(icon24, QString());
        comboFiltros_2->addItem(icon24, QString());
        comboFiltros_2->addItem(icon24, QString());
        comboFiltros_2->addItem(icon24, QString());
        ...
        toolBtn_Filtros2->setIcon(icon10);
...
" }"));
        ...
        sizePolicy3.setHeightForWidth(toolBoxGrafico3->sizePolicy().hasHeightForWidth());
        toolBoxGrafico3->setSizePolicy(sizePolicy3);
        ...
        comboFiltros_3->addItem(icon24, QString());
        comboFiltros_3->addItem(icon24, QString());
        comboFiltros_3->addItem(icon24, QString());
        comboFiltros_3->addItem(icon24, QString());
        comboFiltros_3->addItem(icon24, QString());
        ...
        toolBtn_Filtros3->setIcon(icon10);
        ...
        sizePolicy4.setHeightForWidth(dockGraficosNorm->sizePolicy().hasHeightForWidth());
        dockGraficosNorm->setSizePolicy(sizePolicy4);
        ...
        btnGuardarTabla->setIcon(icon20);
        ...
        QIcon icon25;
        icon25.addFile(QStringLiteral(":/imagenes/magnifyingglass.ico"), QSize(), QIcon::Normal, QIcon::Off);
        btnSearchComents->setIcon(icon25);
...
" }"));
        ...
        sizePolicy5.setHeightForWidth(notasComentarios->sizePolicy().hasHeightForWidth());
        notasComentarios->setSizePolicy(sizePolicy5);
        ...
        QIcon icon26;
        icon26.addFile(QStringLiteral(":/imagenes/graph.ico"), QSize(), QIcon::Normal, QIcon::Off);
        menuAdministrar->setIcon(icon26);
        ...
        QIcon icon27;
        icon27.addFile(QStringLiteral(":/imagenes/ejemplos.png"), QSize(), QIcon::Normal, QIcon::Off);
        menu_Ejemplos->setIcon(icon27);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        infoProyecto_GB->setTitle(QApplication::translate("MainWindow", "Informacion del Proyecto:", 0));
        ...
        comboAnalisis2->insertItems(0, QStringList()
         ...
         << QApplication::translate("MainWindow", "Histogram (Normal)", 0)
